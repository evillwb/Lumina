...
export default function App() {
  ...
  const handleJoyrideCallback = (data: CallBackProps) => {
    ...
    if (data.index === 1 && data.type === "step:after")
      setActiveTab("Smart Notes");
    if (data.index === 2 && data.type === "step:after")
  ...
  const steps = [
    {
      ...
      content:
        "Welcome! This is the Smart Calendar. It automatically schedules topics and reschedules the ones you fail so you never fall behind.",
      disableBeacon: true,
    },
    {
      target: ".tour-smart-notes",
      content:
        "Here, the AI automatically distills your study materials into Smart Notes and allows you to test yourself instantly.",
    },
    {
      target: ".tour-mastery-map",
      content:
        "This is the Mastery Map. Watch your topics turn gold as you demonstrate mastery through quizzes. Good luck!",
    },
  ];
