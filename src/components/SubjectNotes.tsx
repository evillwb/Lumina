    ...
    <div className="flex-1 flex flex-col md:flex-row h-full overflow-hidden bg-neutral-50 dark:bg-[#09090b]">
      ...
      <div className="w-full md:w-64 shrink-0 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 flex flex-col h-full z-10 md:h-auto border-b md:border-b-0 max-h-[30vh] md:max-h-full print:hidden">
        <div className="p-4 border-b border-neutral-200 dark:border-neutral-800">
          <h2 className="text-sm font-bold text-neutral-900 dark:text-neutral-100 py-1 uppercase tracking-wider">
            Notebooks
          </h2>
        </div>
      ...
      <div className="flex-1 flex flex-col h-full bg-[#fcfcfc] dark:bg-[#0a0a0c] overflow-hidden relative">
        {activeSubject ? (
                ...
                <div className="flex items-center text-xs text-neutral-400 dark:text-neutral-500 bg-neutral-100 dark:bg-neutral-800/50 px-3 py-1.5 rounded-full overflow-hidden">
                  <AnimatePresence mode="wait">
                    {isSaving ? (
                      ...
                      >
                        <span className="shrink-0 w-1.5 h-1.5 bg-neutral-400 rounded-full animate-pulse"></span>{" "}
                        Saving...
                      </motion.span>
                    ) : lastSaved ? (
                      <motion.span
                      ...
                      >
                        <Check className="shrink-0 w-3.5 h-3.5" /> Saved{" "}
          ...
          <div className="flex-1 flex items-center justify-center text-neutral-400 flex-col gap-4 animate-in fade-in duration-700">
            ...
            <p className="text-center px-4 max-w-sm text-neutral-500 leading-relaxed">
              Create a notebook to organize your thoughts, or select an existing
