...
export const SyllabusManager: React.FC = () => {
  ...
  const saveTopic = async () => {
    ...
    try {
      ...
      const topicData: any = {
        ...
        masteryLevel: isNew
          ? 0
          : topics.find((t) => t.id === isEditing)?.masteryLevel || 0,
  ...
  const filteredTopics = topics.filter((t) => {
    ...
    const priorityMatch =
      filterPriority === "all" || (t.priority || "normal") === filterPriority;
    ...
    return (
      <div className="flex-1 p-8 flex items-center justify-center flex-col text-center">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          Please sign in with Google from the sidebar to manage your syllabus.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 p-6 md:p-8 overflow-y-auto w-full max-w-5xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-1">
            Manage topics and personal notes for AI quiz generation.
          </p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-sm rounded-2xl p-6 mb-8">
        <h3 className="text-neutral-900 dark:text-white font-medium mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                onClick={() => {
                  setTitle(
                    `${subject === "Custom" ? "New Topic" : subject} Basics`,
                  );
          ...
          <div className="lg:col-span-1">
            ...
            <select
              value={difficulty}
              onChange={(e) =>
                setDifficulty(e.target.value as Topic["difficulty"])
              }
              className="w-full bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg p-3 text-neutral-900 dark:text-white text-sm focus:outline-none focus:border-blue-500"
            >
          ...
          <div className="lg:col-span-1">
            ...
            <select
              ...
              onChange={(e) =>
                setQuizDifficulty(e.target.value as Topic["quizDifficulty"])
              }
              className="w-full bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg p-3 text-neutral-900 dark:text-white text-sm focus:outline-none focus:border-blue-500"
            >
        ...
        >
          ...
          <MDEditor
            ...
            textareaProps={{
              placeholder:
                "Key concepts, formulas, or reminders... e.g. Entropy always increases.",
            }}
          />
        </div>
        ...
        <div className="flex justify-end gap-3">
          {isEditing && (
            <button
              onClick={resetForm}
              className="px-4 py-2 text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white transition-colors"
            >
              Cancel
            </button>
          )}
