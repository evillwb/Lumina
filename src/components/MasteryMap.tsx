...
export const MasteryMap: React.FC = () => {
  ...
  const getMasteryColor = (level: number) => {
    if (level < 31)
      return "bg-neutral-100 dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 hover:border-neutral-400 dark:hover:border-neutral-600";
    if (level < 71)
      return "bg-amber-50 dark:bg-amber-500/10 border-amber-300 dark:border-amber-700/50 text-amber-700 dark:text-amber-400 hover:border-amber-400 dark:hover:border-amber-600";
    ...
    <div className="flex-1 p-8 overflow-y-auto bg-neutral-50 dark:bg-[#09090b]">
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 text-center">
          <h1 className="text-3xl font-black text-neutral-900 dark:text-white tracking-tight mb-3">
            Mastery Map
          </h1>
          <p className="text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto">
            Visualize your learning progress across all subjects. Turn grey
            topics into gold as you master them through quizzes and spaced
            repetition.
          </p>
        </header>
        ...
        {Object.keys(subjectsMap).length === 0 ? (
          <div className="text-center p-12 border-2 border-dashed border-neutral-200 dark:border-neutral-800 rounded-3xl">
            <p className="text-neutral-500">
              No topics found. Start by importing a syllabus!
            </p>
          </div>
        ) : (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {subTopics.map((topic, i) => (
                    ...
                    >
                      ...
                      <h3 className="font-bold text-sm leading-tight mb-2 line-clamp-2 md:px-2">
                        {topic.title}
                      </h3>
                      ...
                      <div className="absolute inset-0 bg-neutral-900/95 text-white p-4 justify-center items-center rounded-xl opacity-0 group-hover:opacity-100 transition-opacity flex flex-col z-10 pointer-events-none">
                        ...
                        <p className="text-xs mb-2">
                          Attempts: {topic.failedAttempts || 0}
                        </p>
