...
export const Settings: React.FC = () => {
  ...
  const handleSpacedRepetitionChange = async (
    key: keyof typeof spacedRepetition,
    value: number,
  ) => {
    ...
    return (
      <div className="flex-1 p-8 flex items-center justify-center flex-col text-center">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          Please sign in with Google to access your settings.
        </p>
      </div>
    );
  }
    ...
    <div className="flex-1 p-6 md:p-8 overflow-y-auto">
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-sm rounded-2xl p-6 max-w-xl">
        ...
        <div className="mb-6 p-4 bg-neutral-50 dark:bg-neutral-950 rounded-xl border border-neutral-200 dark:border-neutral-800 text-sm text-neutral-600 dark:text-neutral-400 space-y-2">
          <p className="font-bold text-neutral-900 dark:text-white mb-2 text-xs uppercase tracking-wider">
            How to import:
          </p>
          <ol className="list-decimal pl-4 space-y-2">
            ...
            <li>
              <strong>Google Calendar:</strong> Open Settings &gt; Import &amp;
              Export, select the downloaded file, and import it into your
              calendar.
            </li>
            <li>
              <strong>Apple Calendar / Outlook:</strong> Simply open or
              double-click the downloaded file to add events automatically.
            </li>
          </ol>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500">
                Select language for interface and AI-generated quizzes.
              </p>
            </div>
          </div>
          <select
        ...
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500">
                Number of days to wait before reviewing a topic based on its
                mastery level.
              </p>
            </div>
          </div>
